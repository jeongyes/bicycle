...
# Load the CSV file
file_path = r'C:\Users\jeong\Desktop\Photonics Project\streamlit_data\부산광역시_자전거대여소_20230822.csv'
...
data['구군'].fillna(data['소재지도로명주소'].apply(extract_gu_gun), inplace=True)
